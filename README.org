# -*- fill-column: 76; -*-
#+TITLE: Fork of XDP Programming Hands-On Tutorial
#+OPTIONS: ^:nil

This repository contains the folder count min that generates a mutidimensional array 4 by 131072 where the packet flows
are hashed and saved.

To hash the packet flow =(ip_src, ip_dst, proto, src_port, dst_port)= i used [[https://github.com/Cyan4973/xxHash/tree/dev][xxHash]].

To install xxHash follow the following steps outside of the xdp-tutorial folder.
